...
const FEATURES = [
  { icon: Shield, title: "Verified Companions", desc: "Every Companion goes through ID & background verification.", color: "#C96F52" },
  { icon: Star, title: "Authentic Experiences", desc: "Skip tourist traps. Discover hidden gems only locals know.", color: "#C96F52" },
  { icon: Users, title: "Women-Only Option", desc: "Female travelers can choose women-only companions for extra comfort.", color: "#C96F52" },
  { icon: Zap, title: "AI Recommendations", desc: "Smart suggestions based on your interests, pace, and travel style.", color: "#C96F52" },
...
export function Landing() {
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#FCFAF5", overflowX: "hidden" }}>
      {/* Nav */}
      <nav
        className="flex items-center justify-between px-8 py-5 sticky top-0 z-50"
        style={{ background: "rgba(255,255,255,0.95)", backdropFilter: "blur(10px)", borderBottom: "1px solid #F4E9D8" }}
      >
        <div className="flex items-center gap-2">
          <div
            className="rounded-xl flex items-center justify-center"
            style={{ width: 36, height: 36, background: "linear-gradient(135deg, #C96F52, #D97A5E)" }}
          >
            <MapPin size={18} color="#FCFAF5" strokeWidth={2.5} />
          </div>
          <span style={{ fontSize: 18, fontWeight: 800, color: "#1A3B2B", letterSpacing: "-0.02em" }}>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            style={{ fontSize: 14, fontWeight: 500, color: "#8B9E94" }}
          >
            Sign In
          </button>
          <button
            ...
            style={{ fontSize: 14, fontWeight: 600, background: "#C96F52", color: "#FCFAF5" }}
          >
            Get Started
          </button>
        </div>
      ...
      >
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #FCFAF53EE 0%, #EFF6FF 50%, #ECFDF5 100%)",
          }}
        />
        <div
          className="absolute top-20 right-0 rounded-full opacity-20"
          style={{ width: 600, height: 600, background: "#C96F52", filter: "blur(120px)" }}
        />
        <div
          className="absolute bottom-0 left-0 rounded-full opacity-15"
          style={{ width: 400, height: 400, background: "#C96F52", filter: "blur(100px)" }}
        />
        ...
        <div className="relative max-w-6xl mx-auto px-8 py-20 grid gap-16" style={{ gridTemplateColumns: "1fr 1fr", alignItems: "center" }}>
          <div>
            <div
              ...
              style={{ background: "#FCFAF53EE", border: "1px solid #FFD6C2" }}
            >
              <span style={{ fontSize: 12, color: "#C96F52", fontWeight: 600 }}>🌍 Now in 150+ Cities Worldwide</span>
            </div>
            ...
            >
              Travel Like a{" "}
              <span style={{ color: "#C96F52", fontFamily: "'DM Serif Display', serif", fontStyle: "italic" }}>
                Local,
              </span>
              <br />
              Not a Tourist.
            ...
            <p style={{ fontSize: 18, color: "#8B9E94", lineHeight: 1.7, marginBottom: 32, maxWidth: 480 }}>
            ...
            <div className="flex items-center gap-8">
              {[
                ...
                <div key={s.label}>
                  <div style={{ fontSize: 28, fontWeight: 800, color: "#1A3B2B" }}>{s.value}</div>
                  <div style={{ fontSize: 13, color: "#8B9E94" }}>{s.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative" style={{ height: 560 }}>
            ...
            <img
              ...
              className="rounded-3xl object-cover absolute"
              style={{ width: 200, height: 260, left: 0, bottom: 0, boxShadow: "0 20px 60px rgba(0,0,0,0.15)", border: "4px solid #FCFAF5" }}
            />
            {/* Floating card */}
            <div
            ...
            >
              <div className="rounded-full" style={{ width: 40, height: 40, background: "#FCFAF53EE", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <Shield size={18} color="#C96F52" />
              </div>
              <div>
                <div style={{ fontSize: 13, fontWeight: 700, color: "#1A3B2B" }}>Verified & Safe</div>
                <div style={{ fontSize: 11, color: "#8B9E94" }}>ID + background check</div>
              </div>
            </div>
            <div
      ...
      {/* Features */}
      <section className="py-24 px-8" style={{ background: "#F4E9D8" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 style={{ fontSize: 44, fontWeight: 800, color: "#1A3B2B", letterSpacing: "-0.02em", marginBottom: 16 }}>
              Why <span style={{ color: "#C96F52" }}>Companion?</span>
            </h2>
            <p style={{ fontSize: 18, color: "#8B9E94", maxWidth: 520, margin: "0 auto" }}>
          ...
          <div className="grid gap-6" style={{ gridTemplateColumns: "repeat(3, 1fr)" }}>
            {FEATURES.map((f) => (
              <div
                ...
                style={{ background: "#FCFAF5", border: "1px solid #F4E9D8", boxShadow: "0 4px 20px rgba(0,0,0,0.04)" }}
              >
                <div
                ...
                <h3 style={{ fontSize: 17, fontWeight: 700, color: "#1A3B2B", marginBottom: 8 }}>{f.title}</h3>
                <p style={{ fontSize: 14, color: "#8B9E94", lineHeight: 1.6 }}>{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Testimonials */}
      <section className="py-24 px-8" style={{ background: "#FCFAF5" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 style={{ fontSize: 44, fontWeight: 800, color: "#1A3B2B", letterSpacing: "-0.02em", marginBottom: 16 }}>
          ...
          <div className="grid gap-6" style={{ gridTemplateColumns: "repeat(3, 1fr)" }}>
            {TESTIMONIALS.map((t) => (
              <div
                ...
                style={{ background: "#F4E9D8", border: "1px solid #F4E9D8" }}
              >
                <div className="flex mb-4">
                  {[...Array(t.rating)].map((_, i) => (
                    <span key={i} style={{ color: "#C96F52", fontSize: 16 }}>★</span>
                  ))}
                </div>
                <p style={{ fontSize: 15, color: "#2C4F3E", lineHeight: 1.7, marginBottom: 20, fontStyle: "italic" }}>
                  "{t.text}"
                </p>
                <div className="flex items-center gap-3">
                  <img src={t.avatar} alt={t.name} className="rounded-full object-cover" style={{ width: 44, height: 44 }} />
                  <div>
                    <div style={{ fontSize: 14, fontWeight: 700, color: "#1A3B2B" }}>{t.name}</div>
                    <div style={{ fontSize: 12, color: "#8B9E94" }}>{t.city}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* Safety */}
      <section className="py-24 px-8" style={{ background: "linear-gradient(135deg, #FCFAF53EE, #EFF6FF)" }}>
        <div className="max-w-5xl mx-auto grid gap-16" style={{ gridTemplateColumns: "1fr 1fr", alignItems: "center" }}>
          <div>
            <div
              ...
              style={{ background: "#FCFAF53EE", border: "1px solid #FFD6C2" }}
            >
              <Shield size={14} color="#C96F52" />
              <span style={{ fontSize: 12, color: "#C96F52", fontWeight: 600 }}>Safety First, Always</span>
            </div>
            <h2 style={{ fontSize: 44, fontWeight: 800, color: "#1A3B2B", letterSpacing: "-0.02em", marginBottom: 20 }}>
            ...
            {[
              ...
              <div key={item} className="flex items-center gap-3 mb-3">
                <CheckCircle size={18} color="#C96F52" />
                <span style={{ fontSize: 15, color: "#2C4F3E" }}>{item}</span>
              </div>
            ))}
            <button
              onClick={() => router.push("/app/safety")}
              className="mt-6 flex items-center gap-2 rounded-2xl px-6 py-3"
              style={{ background: "#1A3B2B", color: "#FCFAF5", fontSize: 15, fontWeight: 600 }}
            >
      ...
      {/* CTA */}
      <section className="py-24 px-8 text-center" style={{ background: "#1A3B2B" }}>
        <div className="max-w-3xl mx-auto">
          <h2 style={{ fontSize: 52, fontWeight: 800, color: "#FCFAF5", letterSpacing: "-0.02em", marginBottom: 20, lineHeight: 1.15 }}>
            Your Next Adventure Starts{" "}
            <span style={{ color: "#C96F52", fontFamily: "'DM Serif Display', serif", fontStyle: "italic" }}>Here</span>
          </h2>
          <p style={{ fontSize: 18, color: "#8B9E94", marginBottom: 36 }}>
          ...
          <div className="flex justify-center gap-4">
            ...
            <button
              onClick={() => router.push("/app/become-local")}
              className="flex items-center gap-2 rounded-2xl px-8 py-4"
              style={{ background: "rgba(255,255,255,0.1)", color: "#FCFAF5", fontSize: 16, fontWeight: 600, border: "1px solid rgba(255,255,255,0.2)" }}
            >
              Become a Companion
            </button>
          </div>
      ...
      {/* Footer */}
      <footer className="py-12 px-8" style={{ background: "#1A3B2B", color: "#8B9E94" }}>
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="rounded-xl flex items-center justify-center" style={{ width: 32, height: 32, background: "#C96F52" }}>
              <MapPin size={16} color="#FCFAF5" strokeWidth={2.5} />
            </div>
            <span style={{ fontSize: 16, fontWeight: 800, color: "#FCFAF5" }}>
              Mebing<span style={{ color: "#C96F52" }}>Local</span>
            </span>
          </div>
          <div className="flex gap-8" style={{ fontSize: 14 }}>
            {["About", "Safety", "Careers", "Blog", "Help"].map((l) => (
              <a key={l} href="#" style={{ color: "#8B9E94" }}>{l}</a>
            ))}
          </div>
